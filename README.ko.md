...
| 버전 | 날짜 | 주요 변경 |
|------|------|---------|
| **[v1.24.5](docs/usage-accounting.md#automatic-historical-accounting-revision)** | 2026-09-10 | 로컬 빌드: 검증된 Codex 과거 과대 집계를 백업과 재개 가능한 소스별 기록으로 자동 수정하고 결과 및 재검사 화면을 제공합니다. |
